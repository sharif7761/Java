...
class AddTransaction extends Frame implements WindowListener,ActionListener{
	...
	public AddTransaction(Register r){
		super("Farm Management System/addtransaction");
		this.register=r;
 ...
 l0=new Label("Add New Transaction");
l0.setFont(new Font("Add New Transaction",Font.PLAIN,20));		 
		  l0.setBounds(20,180, 500,45); 
		  		
		 l1=new Label("Transaction Id");  
		  l1.setFont(new Font("Transaction Id",Font.PLAIN,20));
		  l1.setBounds(30,230,150,30);  
		tf=new TextField();  
        tf.setBounds(300,230,150,30);
		
		l2=new Label("Transaction Name");  
		  l2.setFont(new Font("Transaction Name",Font.PLAIN,20));
		  l2.setBounds(30,280, 150,30);  
		tf1=new TextField();  
        tf1.setBounds(300,280, 150,30);
		
		l8=new Label("Price");  
		  l8.setFont(new Font("Price",Font.PLAIN,20));
		  l8.setBounds(30,320, 150,30);  
		tf2=new TextField();  
        tf2.setBounds(300,320, 150,30);             
		
		l3=new Label("Transaction Description");  
		  l3.setFont(new Font("Transaction Description",Font.PLAIN,20));
		  l3.setBounds(30,370, 210,30);  
		tf3=new TextField();  
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(st.equals("Submit")){
			String sql="insert into transaction (TRid,TRname,Description,Price) values('"+tf.getText()+"','"+tf1.getText()+"','"+tf3.getText()+"','"+tf2.getText()+"')";
				da.updateDB(sql);
	...
	if(st.equals("Home")){
			register.addtransaction.setVisible(false);
